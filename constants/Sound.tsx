...
const MUSIC_TRACK_RESOURCES = {
  ...
  musicBossaBlocks: require('../assets/sounds/generated/music-bossa-blocks.mp3'),
  musicDungeonLow: require('../assets/sounds/generated/music-dungeon-low.mp3'),
  musicMeteorShower: require('../assets/sounds/generated/music-meteor-shower.mp3'),
  musicSunrisePad: require('../assets/sounds/generated/music-sunrise-pad.mp3'),
  musicCircuitCalm: require('../assets/sounds/generated/music-circuit-calm.mp3'),
  musicCrystalRun: require('../assets/sounds/generated/music-crystal-run.mp3'),
  musicOceanPulse: require('../assets/sounds/generated/music-ocean-pulse.mp3'),
  musicDesertNight: require('../assets/sounds/generated/music-desert-night.mp3'),
  musicSteelDream: require('../assets/sounds/generated/music-steel-dream.mp3'),
  musicSnowfall: require('../assets/sounds/generated/music-snowfall.mp3'),
  musicForestWalk: require('../assets/sounds/generated/music-forest-walk.mp3'),
  musicVaporTrail: require('../assets/sounds/generated/music-vapor-trail.mp3'),
  musicPuzzleFocus: require('../assets/sounds/generated/music-puzzle-focus.mp3'),
  musicThunderRoom: require('../assets/sounds/generated/music-thunder-room.mp3'),
  musicKotoSteps: require('../assets/sounds/generated/music-koto-steps.mp3'),
  musicWesternDust: require('../assets/sounds/generated/music-western-dust.mp3'),
  musicDeepHouse: require('../assets/sounds/generated/music-deep-house.mp3'),
  musicChipCalm: require('../assets/sounds/generated/music-chip-calm.mp3'),
  musicMarimbaRun: require('../assets/sounds/generated/music-marimba-run.mp3'),
  musicCosmicBell: require('../assets/sounds/generated/music-cosmic-bell.mp3'),
} as const;
...
const SFX_RESOURCES = {
  ...
  sfxQuartzPlace: require('../assets/sounds/generated/sfx-quartz-place.mp3'),
  sfxQuartzClear: require('../assets/sounds/generated/sfx-quartz-clear.mp3'),
  sfxQuartzClick: require('../assets/sounds/generated/sfx-quartz-click.mp3'),
  sfxVelvetPlace: require('../assets/sounds/generated/sfx-velvet-place.mp3'),
  sfxVelvetClear: require('../assets/sounds/generated/sfx-velvet-clear.mp3'),
  sfxVelvetClick: require('../assets/sounds/generated/sfx-velvet-click.mp3'),
  sfxArcadePlace: require('../assets/sounds/generated/sfx-arcade-place.mp3'),
  sfxArcadeClear: require('../assets/sounds/generated/sfx-arcade-clear.mp3'),
  sfxArcadeClick: require('../assets/sounds/generated/sfx-arcade-click.mp3'),
  sfxMoonPlace: require('../assets/sounds/generated/sfx-moon-place.mp3'),
  sfxMoonClear: require('../assets/sounds/generated/sfx-moon-clear.mp3'),
  sfxMoonClick: require('../assets/sounds/generated/sfx-moon-click.mp3'),
  sfxJadePlace: require('../assets/sounds/generated/sfx-jade-place.mp3'),
  sfxJadeClear: require('../assets/sounds/generated/sfx-jade-clear.mp3'),
  sfxJadeClick: require('../assets/sounds/generated/sfx-jade-click.mp3'),
  sfxRainPlace: require('../assets/sounds/generated/sfx-rain-place.mp3'),
  sfxRainClear: require('../assets/sounds/generated/sfx-rain-clear.mp3'),
  sfxRainClick: require('../assets/sounds/generated/sfx-rain-click.mp3'),
  sfxPearlPlace: require('../assets/sounds/generated/sfx-pearl-place.mp3'),
  sfxPearlClear: require('../assets/sounds/generated/sfx-pearl-clear.mp3'),
  sfxPearlClick: require('../assets/sounds/generated/sfx-pearl-click.mp3'),
  sfxThunderPlace: require('../assets/sounds/generated/sfx-thunder-place.mp3'),
  sfxThunderClear: require('../assets/sounds/generated/sfx-thunder-clear.mp3'),
  sfxThunderClick: require('../assets/sounds/generated/sfx-thunder-click.mp3'),
  sfxNeonPlace: require('../assets/sounds/generated/sfx-neon-place.mp3'),
  sfxNeonClear: require('../assets/sounds/generated/sfx-neon-clear.mp3'),
  sfxNeonClick: require('../assets/sounds/generated/sfx-neon-click.mp3'),
  sfxSnowPlace: require('../assets/sounds/generated/sfx-snow-place.mp3'),
  sfxSnowClear: require('../assets/sounds/generated/sfx-snow-clear.mp3'),
  sfxSnowClick: require('../assets/sounds/generated/sfx-snow-click.mp3'),
  sfxCopperPlace: require('../assets/sounds/generated/sfx-copper-place.mp3'),
  sfxCopperClear: require('../assets/sounds/generated/sfx-copper-clear.mp3'),
  sfxCopperClick: require('../assets/sounds/generated/sfx-copper-click.mp3'),
  sfxGhostPlace: require('../assets/sounds/generated/sfx-ghost-place.mp3'),
  sfxGhostClear: require('../assets/sounds/generated/sfx-ghost-clear.mp3'),
  sfxGhostClick: require('../assets/sounds/generated/sfx-ghost-click.mp3'),
  sfxLimePlace: require('../assets/sounds/generated/sfx-lime-place.mp3'),
  sfxLimeClear: require('../assets/sounds/generated/sfx-lime-clear.mp3'),
  sfxLimeClick: require('../assets/sounds/generated/sfx-lime-click.mp3'),
  sfxOrbitPlace: require('../assets/sounds/generated/sfx-orbit-place.mp3'),
  sfxOrbitClear: require('../assets/sounds/generated/sfx-orbit-clear.mp3'),
  sfxOrbitClick: require('../assets/sounds/generated/sfx-orbit-click.mp3'),
  sfxBronzePlace: require('../assets/sounds/generated/sfx-bronze-place.mp3'),
  sfxBronzeClear: require('../assets/sounds/generated/sfx-bronze-clear.mp3'),
  sfxBronzeClick: require('../assets/sounds/generated/sfx-bronze-click.mp3'),
  sfxSilkPlace: require('../assets/sounds/generated/sfx-silk-place.mp3'),
  sfxSilkClear: require('../assets/sounds/generated/sfx-silk-clear.mp3'),
  sfxSilkClick: require('../assets/sounds/generated/sfx-silk-click.mp3'),
  sfxStarlightPlace: require('../assets/sounds/generated/sfx-starlight-place.mp3'),
  sfxStarlightClear: require('../assets/sounds/generated/sfx-starlight-clear.mp3'),
  sfxStarlightClick: require('../assets/sounds/generated/sfx-starlight-click.mp3'),
  sfxClackPlace: require('../assets/sounds/generated/sfx-clack-place.mp3'),
  sfxClackClear: require('../assets/sounds/generated/sfx-clack-clear.mp3'),
  sfxClackClick: require('../assets/sounds/generated/sfx-clack-click.mp3'),
  sfxPeachPlace: require('../assets/sounds/generated/sfx-peach-place.mp3'),
  sfxPeachClear: require('../assets/sounds/generated/sfx-peach-clear.mp3'),
  sfxPeachClick: require('../assets/sounds/generated/sfx-peach-click.mp3'),
  sfxVoidPlace: require('../assets/sounds/generated/sfx-void-place.mp3'),
  sfxVoidClear: require('../assets/sounds/generated/sfx-void-clear.mp3'),
  sfxVoidClick: require('../assets/sounds/generated/sfx-void-click.mp3'),
} as const;
...
const MUSIC_PACK_TRACKS: Record<string, BuiltInMusicTrackKey> = {
  ...
  music_bossa_blocks: 'musicBossaBlocks',
  music_dungeon_low: 'musicDungeonLow',
  music_meteor_shower: 'musicMeteorShower',
  music_sunrise_pad: 'musicSunrisePad',
  music_circuit_calm: 'musicCircuitCalm',
  music_crystal_run: 'musicCrystalRun',
  music_ocean_pulse: 'musicOceanPulse',
  music_desert_night: 'musicDesertNight',
  music_steel_dream: 'musicSteelDream',
  music_snowfall: 'musicSnowfall',
  music_forest_walk: 'musicForestWalk',
  music_vapor_trail: 'musicVaporTrail',
  music_puzzle_focus: 'musicPuzzleFocus',
  music_thunder_room: 'musicThunderRoom',
  music_koto_steps: 'musicKotoSteps',
  music_western_dust: 'musicWesternDust',
  music_deep_house: 'musicDeepHouse',
  music_chip_calm: 'musicChipCalm',
  music_marimba_run: 'musicMarimbaRun',
  music_cosmic_bell: 'musicCosmicBell',
};
...
const MUSIC_TRACK_VOLUME_MULTIPLIERS: Partial<Record<BuiltInMusicTrackKey, number>> = {
  ...
  musicDungeonLow: 0.76,
  musicSnowfall: 0.72,
  musicPuzzleFocus: 0.7,
  musicThunderRoom: 0.84,
  musicDeepHouse: 0.94,
};
...
const SFX_PACK_ASSETS: Record<string, SfxRoleAssets> = {
  ...
  sfx_quartz: sfxPack('Quartz'),
  sfx_velvet: sfxPack('Velvet'),
  sfx_arcade: sfxPack('Arcade'),
  sfx_moon: sfxPack('Moon'),
  sfx_jade: sfxPack('Jade'),
  sfx_rain: sfxPack('Rain'),
  sfx_pearl: sfxPack('Pearl'),
  sfx_thunder: sfxPack('Thunder'),
  sfx_neon: sfxPack('Neon'),
  sfx_snow: sfxPack('Snow'),
  sfx_copper: sfxPack('Copper'),
  sfx_ghost: sfxPack('Ghost'),
  sfx_lime: sfxPack('Lime'),
  sfx_orbit: sfxPack('Orbit'),
  sfx_bronze: sfxPack('Bronze'),
  sfx_silk: sfxPack('Silk'),
  sfx_starlight: sfxPack('Starlight'),
  sfx_clack: sfxPack('Clack'),
  sfx_peach: sfxPack('Peach'),
  sfx_void: sfxPack('Void'),
};
